...
# --- User and Student Functions (from before) ---
...
# --- New Task, Submission, and Gamification Functions ---
...
# --- Functions to add default content (for hackathon demo) ---
